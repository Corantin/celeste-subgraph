...
export class DisputeManager__getRoundResult {
  ...
  getDelayedTerms(): BigInt {
    return this.value1;
  }

  getJurorsNumber(): BigInt {
    return this.value2;
  }

  getSelectedJurors(): BigInt {
    return this.value3;
  }
  ...
  getCollectedTokens(): BigInt {
    return this.value6;
  }

  getCoherentJurors(): BigInt {
    return this.value7;
  }
...
export class DisputeManager__getNextRoundDetailsResult {
  ...
  getNextRoundStartTerm(): BigInt {
    return this.value0;
  }

  getNextRoundJurorsNumber(): BigInt {
    return this.value1;
  }

  getNewDisputeState(): i32 {
    return this.value2;
  }
  ...
  getAppealDeposit(): BigInt {
    return this.value6;
  }

  getConfirmAppealDeposit(): BigInt {
    return this.value7;
  }
}
...
export class DisputeManager__getDisputeResult {
  ...
  getLastRoundId(): BigInt {
    return this.value4;
  }

  getCreateTermId(): BigInt {
    return this.value5;
  }
}
