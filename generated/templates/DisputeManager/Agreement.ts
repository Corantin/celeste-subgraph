...
export class Agreement__getSettingResult {
  ...
  getAragonAppFeesCashier(): Address {
    return this.value1;
  }
...
export class Agreement__getDisputableInfoResult {
  ...
  getCurrentCollateralRequirementId(): BigInt {
    return this.value1;
  }
}
...
export class Agreement__getCollateralRequirementResult {
  ...
  getActionAmount(): BigInt {
    return this.value1;
  }

  getChallengeAmount(): BigInt {
    return this.value2;
  }

  getChallengeDuration(): BigInt {
    return this.value3;
  }
}
...
export class Agreement__getActionResult {
  ...
  getDisputable(): Address {
    return this.value0;
  }

  getDisputableActionId(): BigInt {
    return this.value1;
  }

  getCollateralRequirementId(): BigInt {
    return this.value2;
  }
...
export class Agreement__getChallengeResult {
  ...
  getSubmitterFinishedEvidence(): boolean {
    return this.value6;
  }

  getChallengerFinishedEvidence(): boolean {
    return this.value7;
  }
...
export class Agreement__getChallengeArbitratorFeesResult {
  ...
  getChallengerArbitratorFeesAmount(): BigInt {
    return this.value0;
  }

  getChallengerArbitratorFeesToken(): Address {
    return this.value1;
  }

  getSubmitterArbitratorFeesAmount(): BigInt {
    return this.value2;
  }

  getSubmitterArbitratorFeesToken(): Address {
    return this.value3;
  }
}
